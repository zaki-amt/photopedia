                      ...
                      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 max-w-5xl">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] font-mono font-semibold uppercase tracking-widest bg-white text-black px-2 py-0.5 rounded">
                              {slide.category}
                            </span>
                        ...
                        <div className="flex items-center gap-4 bg-black/60 border border-zinc-800/80 backdrop-blur-md p-2.5 px-4 rounded-xl">
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img
                            src={slide.avatar}
                            alt={slide.author}
                          ...
                          <div className="text-left">
                            <p className="text-xs font-semibold text-white font-heading">{slide.author}</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        <h3 className="font-heading text-base font-bold text-white">{creator.name}</h3>
