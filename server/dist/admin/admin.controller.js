...
let AdminController = class AdminController {
    ...
    async toggleRole(req, userId) {
        this.checkAdmin(req);
        return this.adminService.toggleUserRole(userId);
    }
    async getModeration(req) {
        this.checkAdmin(req);
        return this.adminService.getModerationQueue();
    }
    async updateModeration(req, logId, status) {
        this.checkAdmin(req);
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminController.prototype, "toggleRole", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminController.prototype, "updateModeration", null);
